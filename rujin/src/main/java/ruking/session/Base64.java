...
//along with this program in the file 'gpl.jhtml'; if not, write to  //
...
//if (data.length>0 && data[len-1] == '=') --len; /* this line is a bug
//if (data.length>0 && data[len-2] == '=') --len; /* this line is a bug
...
{
System.out.print(encode("andyfly78@hotmail.com".getBytes()));
}
}
